...
function set_stage_1() {
    control_title.textContent = 'Prepare to launch';
    control_button.textContent = " Start Countdown";
    control_button.classList.remove('hide');
    set_rocket_state('state1')
    control_button.onclick = set_stage_2;
...
function set_stage_2() {
    console.log('stage 2')
    control_title.textContent = 'counting down';
    control_button.textContent = 'abort';
    set_rocket_state('state2')
    control_button.onclick = set_stage_1;
}
